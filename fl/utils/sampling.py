...
def mnist_noniid(dataset, num_users):
    ...
    :return:
    """
    num_imgs = int(60000/(2*num_users))

    idx_shard = [i for i in range(2*num_users)]
    dict_users = {i: np.array([], dtype='int64') for i in range(num_users)}
    idxs = np.arange(2*num_users*num_imgs)
...
def cifar_10_noniid(dataset, num_users):
    ...
    :return:
    """
    num_imgs = int(50000/(2*num_users))
