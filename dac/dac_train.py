...
parser.add_argument('--json_name', default='net_small.json', type=str, help='network configs file')
parser.add_argument('--net_config_id', default=196, type=int, help='network configs index')
...
net_cfg = net_config_dict[str(args.net_config_id)]['cfg']
net = mbn2_nas.mbn2_nas(net_cfg)
# if device == 'cuda':
